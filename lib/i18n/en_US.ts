export default {
  ...
  dashboard: {
    ...
    host_token_verify_success: 'Host token verified successfully',
    ...
    menu: {
      ...
      log: 'Log',
      license: 'License',
      licenseManage: 'Certificate Management',
    },
    ...
    manage: {
      ...
      owner: 'Owner',
      actions: 'Actions',
      new_owner_placeholder: 'New Owner',
    },
    licenseManage: {
      title: 'Certificate Management',
      enterToken: 'Please enter your host token to manage certificates.',
      verify: 'Verify',
      tabView: 'View Certificates',
      tabCreate: 'Create Certificate',
      tabUpdate: 'Update Certificate',
      tabValidate: 'Validate Certificate',
      tableEmail: 'Email',
      ...
      formEmailRequired: 'Please enter a valid email',
      formDomains: 'Domains (comma separated, use * for all)',
      formDomainsPlaceholder: '* or example.com,example2.com',
      formDomainsRequired: 'Please enter domains',
      createBtn: 'Create Certificate & Send Email',
      createSuccess: 'Certificate created: {value}...',
      createModalTitle: 'Certificate Created',
      licenseValue: 'Certificate Value',
      emailSent: 'Email sent to user.',
      emailFailed: 'Email failed to send.',
      createFailed: 'Failed to create certificate',
      updateOriginalEmail: 'Original Email',
      updateLicenseValue: 'Certificate Value',
      updateLicenseValueRequired: 'Please enter certificate value',
      updateNewDomains: 'New Domains (leave blank to keep)',
      updateNewEmail: 'New Email (leave blank to keep)',
      updateBtn: 'Update Certificate',
      updateSuccess: 'Certificate updated',
      updateAndSendBtn: 'Update & Send',
      updateAndSendSuccess: 'Certificate updated and email sent',
      updateFailed: 'Failed to update certificate',
      validatePlaceholder: 'Paste certificate value to validate',
      validateBtn: 'Validate',
      validateValid: 'Certificate is valid',
      validateExpired: 'Certificate is expired',
      validateInvalid: 'Certificate is expired or invalid',
      validateNotFound: 'Certificate not found in database',
      validateFailed: 'Failed to validate certificate',
      validateNotInDb: 'Certificate is valid (not stored in database)',
      fieldEmail: 'Email',
      fieldDomains: 'Domains',
      fieldCreatedAt: 'Created At',
      fieldExpiresAt: 'Expires At',
      fieldLimit: 'Limit Type',
      fieldId: 'Certificate ID',
      formType: 'Certificate Type',
      formRoomName: 'Room Name',
      formRoomNameRequired: 'Please enter a room name',
      typeFree: 'Free',
      typePro: 'Pro',
      typeEnterprise: 'Enterprise',
      typeRoom: 'Room',
      importToDb: 'Import to Database',
      importToDbSuccess: 'Certificate imported to database successfully',
      importToDbError: 'Failed to import certificate',
      generateBtn: 'Generate & Send',
      generateOnlyBtn: 'Generate Only',
      extendTitle: 'Extend Certificate',
      extendCurrentExpires: 'Current Expires',
      extendBy: 'Extend by',
      extendDays3: '3 days',
      extendDays7: '7 days',
      extendDays30: '30 days',
      extendDays180: '6 months',
      extendDays365: '1 year',
      extendSuccess: 'Certificate extended by {days} days',
      fetchFailed: 'Failed to fetch certificates',
      deleteBtn: 'Delete',
      deleteConfirmTitle: 'Confirm Delete',
      deleteConfirmContent: 'Are you sure you want to delete the certificate for {email}?',
      deleteSuccess: 'Certificate deleted',
      deleteFailed: 'Failed to delete certificate',
    },
    log: {
      title: 'Heartbeat Logs',
      cleanup_title: 'Today\'s Cleanup Records',
      refresh: 'Refresh',
      clear: 'Clear',
    ...
    export: {
      space_label: 'Space',
      children_label: 'Sub-rooms',
      none: 'None',
      users_label: 'Users',
    },
    recording: {
      title: 'Recording Management',
      description: 'Enter room name to find and manage recording video files',
      input_placeholder: 'Enter room name',
      search: 'Search',
      refresh: 'Refresh',
      refresh_tooltip: 'Refresh data',
      current_room: 'Current Room',
      total_files: 'Total',
      list_title: 'Recording File List',
      empty_description: 'Enter room name and search to view recording files',
      please_input_room: 'Please enter room name',
      search_success: 'Successfully found recording files',
      search_empty: 'No recording files found, please check if the room name is correct, there may be no recording files or they have been deleted',
