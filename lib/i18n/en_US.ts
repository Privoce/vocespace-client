export default {
  ...
  common: {
    ...
    whiteboard: {
      ...
      only_one_tile: 'Only one whiteboard is allowed in a space',
      create_failed: 'Failed to create whiteboard',
  ...
  channel: {
    feedback: {
      ...
      email: 'Your email',
      email_placeholder: 'Enter a reachable email address',
      type: 'Issue type',
      other_placeholder: 'Enter a custom issue type',
      content: 'Details',
      content_placeholder: 'Describe the bug, error, question, or suggestion',
      attachments: 'Attachments',
      upload_action: 'Upload file or screenshot',
      upload_hint:
        'Uploads are async. Each file is limited to 10MB and will be saved under the feedback directory, then attached as a link in the email.',
      upload_success: 'Attachment uploaded',
      upload_error: 'Attachment upload failed',
      uploading: 'Uploading',
      upload_done: 'Uploaded',
      upload_failed: 'Upload failed',
      uploading_wait: 'Please wait for attachments to finish uploading before submitting.',
      submit_success: 'Feedback sent successfully.',
      ...
      validation: {
        ...
        type_required: 'Please enter an issue type',
        content_required: 'Please enter feedback details',
  ...
  dashboard: {
    ...
    conf: {
      ...
      hyperbeam: {
        title: 'Configure Hyperbeam',
        api_key: 'API Key',
        api_base: 'API Base URL',
        default_start_url: 'Default Start URL',
      },
    ...
    count: {
      ...
      smtp_conf: 'SMTP Config',
      hyperbeam_conf: 'Hyperbeam Config',
      history: {
    ...
    drive: {
      ...
      max_framerate: 'Max Framerate',
      redis_host: 'Redis Host',
      redis_port: 'Redis Port',
      smtp_secure: 'Use secure SMTP connection',
      review_desc: 'After saving, you can continue editing SMTP, Hyperbeam, image quality, and create-space policy from the Dashboard.',
      prev: 'Previous',
      next: 'Next',
      submit: 'Create Config',
      validation: {
        base: 'Please fill in LiveKit, server domain, and host token first',
        smtp: 'SMTP password is required when SMTP user is provided',
