      ...
      >
        ...
        >
          ...
          {visibleControls.screenShare && browserSupportsScreenSharing && (
            <TrackToggle
              style={{ height: 46, padding: 15, backgroundColor: '#F59346' }}
        ...
        {visibleControls.leave && (
          <DisconnectButton style={{ height: 46, backgroundColor: '#f8422a', color: '#ffffff', display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
            {showIcon && (
              <span>
                <svg
            ...
            {showText && <span style={{ color: '#fff' }}>{t('common.leave')}</span>}
          </DisconnectButton>
        )}
        {/* <StartMediaButton /> */}
        {space && (
