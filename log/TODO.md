...
- [x] progress ui 颜色调整
- [x] 侧边栏收回bug
- [x] recording bug （网络问题） 
- [x] 手机布局
- [x] 摄像头翻转 经过测试是可以翻转的，Chrome
- [x] 空间持久化 1
  - [x] 主持人设置
  - [x] 设置API
  - [x] 控制离开空间行为
...
- [x] 应用共享 3
  ...
  - [x] 上传应用接口API
  - [x] 上传历史
  - [x] 一个用户只能上传一组上传（以用户ID限制方式）
  - [x] 是否上传放在设置中，开启则修改后自动上传
  - [x] 重构应用组件
  - [x] widget单独可分享
...
- [x] dashboard 参会时长排序 2
  ...
  - [x] 调整存储结构
- [x] 调整聊天badge的浮动层级
- [x] 公开的子房间，默认展开，私密的就还是点击在展开
- [x] 画质设置调整放到dashboard中
  - [x] 单独抽出画质配置组件
  - [x] dashboard中增加设置按钮
...
localhost:3000/ato?username=王奕娴&userId=2954&roomId=3493&roomName=智造未来
localhost:3000/ato?username=董建豪&userId=84&roomId=3493&roomName=智造未来
chatroom.opencamp.cn/atomgit-porting?username=王奕娴&userId=2954&roomId=3493&roomName=智造未来
chatroom.opencamp.cn/atomgit-porting?username=董建豪&userId=84&roomId=3493&roomName=智造未来
